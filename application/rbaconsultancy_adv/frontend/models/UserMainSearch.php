...
class UserMainSearch extends UserMain
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'user_lastname', 'user_firstname', 'user_midname', 'user_mobile', 'user_telephone', 'user_housenum', 'user_street', 'user_city', 'user_country', 'user_gender', 'user_companyname', 'user_companyadd', 'user_companycontact', 'user_birthdate', 'user_type'], 'safe'],
        ];
    }
