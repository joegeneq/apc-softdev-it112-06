...
class User extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['user_lastname', 'user_firstname', 'user_midname', 'user_housenum', 'user_street', 'user_city', 'user_country'], 'string', 'max' => 25],
            [['user_mobile', 'user_telephone', 'user_companyname', 'user_companyadd', 'user_companycontact'], 'string', 'max' => 45],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'user_companycontact' => 'Company Contact No.',
